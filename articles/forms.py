...
class ArticleForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            "image_alt_fr": _("Texte alternatif [fr]"),
            "image_alt_de": _("Texte alternatif [de]"),
            "image_alt_en": _("Texte alternatif [en]"),
            "image": _("Image principale"),
            "categorie": _("Catégorie"),
            "sponsor": _("Sponsor"),
            "est_sponsorise": _("Article sponsorisé"),
            "is_premium": _("Contenu premium"),
            "en_vedette": _("Article à la une"),
            "ordre_affichage": _("Ordre d’affichage"),
        }
        help_texts = {
            "titre_de": _(
            ...
            "image_alt_fr": _(
                "Facultatif : le titre de l’article sera utilisé si ce champ est vide."
            ),
            "image_alt_de": _(
                "Facultatif : le texte français, puis le titre, seront utilisés si ce champ est vide."
            ),
            "image_alt_en": _(
                "Facultatif : le texte français, puis le titre, seront utilisés si ce champ est vide."
            ),
            "ordre_affichage": _(
                "Les valeurs les plus petites apparaissent en premier."
            ),
        }
        error_messages = {
        ...
        widgets = {
            ...
            "image_alt_fr": forms.TextInput(attrs={"class": "form-control"}),
            "image_alt_de": forms.TextInput(attrs={"class": "form-control"}),
            "image_alt_en": forms.TextInput(attrs={"class": "form-control"}),
            ...
            "en_vedette": forms.CheckboxInput(attrs={"class": "form-check-input"}),
        }
